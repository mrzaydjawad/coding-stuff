bitch = input("on a scale on 1 to 10 how ya doing bitch")
bitch = float(bitch)
print("so basically. . .")
print("wanna know how to calculate the volume and the total surface area of a cuboid")
print("you're gonna have to enter some numbers k good")
